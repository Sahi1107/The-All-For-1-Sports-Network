  ...
  return (
    <div className="space-y-4 pb-24">
      <div className="flex items-center justify-between">
        <Link to="/admin/stat-tracker" className="text-sm text-gray-custom hover:text-white">← Stat Tracker</Link>
        <span className="flex items-center gap-1.5 text-xs px-2 py-1 rounded-full bg-amber-500/15 text-amber-300 border border-amber-500/30">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-dark-light border-t border-dark-lighter px-4 py-3 flex items-center justify-between gap-2 z-20">
